...
def get_enstatite_bulk_theia_core_si_pct(bst_composition: dict, ax, enstatite_mg_si=0.758, core_fraction=0.33,
    ...
    if ax is not None:
        ...
        ax.axvspan(min_al_si, max_al_si, alpha=0.3, color='grey')
