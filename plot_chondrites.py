...
path = "/Users/scotthull/Documents - Scott’s MacBook Pro/PhD Research/MAGMApy/data/Chondrite MgSi vs AlSi.txt"
...
for index, t in enumerate(types):
    ...
    if len(rows) > 1:
        ...
        width, height, angle = get_ellipse_params(n, ax, edgecolor=colors[index], fill=True,
                                                  facecolor=colors[index], alpha=0.4)
